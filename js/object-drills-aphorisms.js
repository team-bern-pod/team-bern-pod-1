...
// console.log(aphorisms[5].quote + " -" + aphorisms[5].author);

//TODO: After doing this 'manually' why is a loop more beneficial? --> it allows to type in the similar code one time for multiple results.  allows for iteration.
...
function formatQuote(input) {
	var outputString = input.quote + " -" + input.author;
	return outputString;
}
